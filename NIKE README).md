4# Nike – Shorts & TikTok Insights

![Nike Short-Form Video Analytics](https://img.shields.io/badge/Project-Nike%202025%20Analytics-111111?style=for-the-badge)
![SQL](https://img.shields.io/badge/SQL-MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white)
![Python](https://img.shields.io/badge/Python-Data%20%2B%20ML-3776AB?style=flat-square&logo=python&logoColor=white)
![Power BI](https://img.shields.io/badge/Power%20BI-Dashboard-F2C811?style=flat-square&logo=powerbi&logoColor=black)
![Machine Learning](https://img.shields.io/badge/ML-K--Means-FF6F00?style=flat-square)
...
1. **SQL Analysis** – answer 12 Nike-relevant business questions.
2. **Power BI Dashboard** – convert the analysis into an executive-friendly interactive report.
3. **Machine Learning** – use K-Means clustering to group videos based on content and engagement characteristics.
...
![K-Means Clustering](assets/ml-clustering.png)
...
| File | Description |
|---|---|
| `nike_capstone.sql` | SQL analysis covering 12 business questions |
| `MODEL_TRAIN_TEST.IPYNB` | Machine-learning notebook using K-Means |
| `S NIKE DASHBOARD.pbix` | Power BI interactive dashboard |
| `README.md` | Project documentation |
| `assets/ml-clustering.png` | ML clustering visualization |
| `youtube_shorts_tiktok_trends_2025.csv` | Source dataset, if permitted |
